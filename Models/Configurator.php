...
class Configurator extends ModelEntity
{
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="AtsdConfigurator\Models\Configurator\Fieldset", mappedBy="configurator", orphanRemoval=true)
     */
     ...
     *
     * @param Configurator\Fieldset $fieldset
     *
     * @return void
     */

    public function addFieldset(Configurator\Fieldset $fieldset)
    {
        // Not included?
    ...
    public function removeFieldset( Configurator\Fieldset $fieldset )
    {
        // Included?
        if ( $this->fieldsets->contains( $fieldset ) )
            // remove it
