...
namespace AtsdConfigurator\Models\Configurator;
...
class Fieldset extends ModelEntity
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="AtsdConfigurator\Models\Configurator", inversedBy="fieldsets")
     ...
     *
     * @ORM\OneToMany(targetEntity="AtsdConfigurator\Models\Configurator\Fieldset\Element", mappedBy="fieldset", orphanRemoval=true)
    ...
    public function addElement(Fieldset\Element $element)
    {
    ...
    public function removeElement(Fieldset\Element $element)
    {
        if($this->elements->contains( $element ) )
