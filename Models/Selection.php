...
class Selection extends ModelEntity
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="AtsdConfigurator\Models\Configurator")
     ...
     *
     * @ORM\OneToMany(targetEntity="AtsdConfigurator\Models\Selection\Article", mappedBy="selection", orphanRemoval=true)
     */
